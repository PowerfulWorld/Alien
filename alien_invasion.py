...
class AlienInvasion:
    ...
    def _fire_bullet(self):
        """Создание нового снаряда и включение в его в группу Bullets"""
    ...
    def _update_bullets(self):
        ...
        # Удаление снарядов достигщих края экрана
    ...
    def _create_fleet(self):
        ...
        # Интервал между соседними пришельцами равен ширинен пришельца
        alien = Alien(self)
        ...
        """Определяет количиество рядов, помещающихся на экране"""
        ship_height = self.ship.rect.height
        available_space_y = (self.settings.screen_height - (3 * alien_height) - ship_height)
        number_rows = available_space_y // (3 * alien_height)

        # Создане флота вторжения
    ...
    def _update_aliens(self):
        """Обновляет позиции всех приешельцев во флоте"""
        ...
        # Проверка не добрались ли пришельцы до нижнего края экрана
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Происходит тоже самое что и при сталкновении с кораблем
                self._ship_hit()
                break
